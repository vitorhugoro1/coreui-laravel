    ...
    <ul class="nav nav-tabs" role="tablist">
      <li class="nav-item">
        <a
          ...
          aria-selected="true"
        >
          <i class="icon-calculator"></i> Subscription Values
        </a>
      </li>
      <li class="nav-item" v-if="is_free == 'false'">
        <a
          ...
          alt="Soon"
        >
          <i class="fa fa-money-check-alt"></i> Discount Rules
        </a>
      </li>
      <li class="nav-item" v-if="is_free == 'false' && hasBankCash()">
        <a
          ...
          aria-selected="false"
        >
          <i class="fa fa-money-check-alt"></i> Bank Accounts
        </a>
      </li>
    </ul>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="form-group">
              ...
              <date-range id="subscription_period" name="subscription_period" :make-required="true"></date-range>
            </div>
          </div>
          <div class="col-lg-6">
              ...
              <div class="controls">
                <div class="input-prepend input-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    v-model.lazy="additional_amount"
                    v-money="moneyRules"
                    type="text"
                  >
                </div>
