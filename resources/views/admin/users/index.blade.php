	...
	<div class="animate fadeIn">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<a class="btn btn-outline-primary" href="{{ route('admin.users.create') }}">Create</a>
							...
							<table-column label="" :sortable="false" :filterable="false">
								<template slot-scope="row">
									<div class="btn-group" role="group">
										<a :href="`{{ url('admin/users') }}/${row.id}/edit`" class="btn btn-secondary"><i class="fa fa-edit"></i></a>
